    ...
    <div className="min-h-screen flex flex-col bg-background" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card dir={isRTL ? 'rtl' : 'ltr'}>
            <CardHeader className={isRTL ? 'text-right' : 'text-left'}>
              <CardTitle className={`flex items-center gap-2 ${isRTL ? 'flex-row-reverse justify-end' : ''}`}>
                ...
                <span>{t('refund.policiesTitle')}</span>
              </CardTitle>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {refundPolicies.map((policy, index) => (
                  <div key={index} dir={isRTL ? 'rtl' : 'ltr'} className={`p-4 rounded-lg border ${policy.bgColor} ${isRTL ? 'text-right' : 'text-left'}`}>
                    <div className="flex items-center gap-2 mb-3">
                      <policy.icon className={`w-5 h-5 flex-shrink-0 ${policy.color}`} />
          ...
          <Card dir={isRTL ? 'rtl' : 'ltr'}>
            <CardHeader className={isRTL ? 'text-right' : 'text-left'}>
              <CardTitle className={`flex items-center gap-2 w-full ${isRTL ? 'flex-row-reverse justify-end text-right' : 'text-left'}`}>
                <CreditCard className="w-5 h-5" />
                <span>{t('refund.processTitle')}</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
