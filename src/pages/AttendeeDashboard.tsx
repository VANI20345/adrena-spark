          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {stats.monthlyGrowth.points > 0 
                    ? `+${stats.monthlyGrowth.points} points this month` 
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {stats.monthlyGrowth.organizers > 0 
                    ? `+${stats.monthlyGrowth.organizers} new organizer${stats.monthlyGrowth.organizers > 1 ? 's' : ''}` 
                    : 'No new organizers'}
                </p>
              </CardContent>
            </Card>
