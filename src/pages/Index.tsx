...
const Index = () => {
  ...
  const showGroups = isStaff || toggles.groups;
  const showServices = isStaff || toggles.services;
  const showTrainings = isStaff || toggles.trainings;
  const showDiscounts = isStaff || toggles.discounts;
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <main className="flex-1">
          ...
          {showGroups && <JoinSuggestions />}
          {showServices && <RecentServices />}
          {showDiscounts && <DiscountedEvents />}
