            ...
            <div className="grid gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>إدارة رصيدك المالي والمعاملات</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center p-6 bg-primary/5 rounded-lg">
                      <div className="text-3xl font-bold text-primary mb-2">
                        {stats.wallet_balance.toFixed(2)} ر.س
                      </div>
                    ...
                    <div className="text-center p-6 bg-blue-50 rounded-lg">
                      ...
                      <div className="text-sm text-muted-foreground">عمولة المنصة</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <h4 className="font-semibold">آخر المعاملات</h4>
                    <div className="space-y-3">
                      {/* Sample transactions - in real app load from database */}
                      <div className="flex items-center justify-between p-3 bg-secondary/50 rounded-lg">
                        <div className="flex items-center gap-3">
                          <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                          <div>
                            <p className="font-medium">إيداع من فعالية "مغامرة الصحراء"</p>
                            <p className="text-sm text-muted-foreground">منذ 3 أيام</p>
                          </div>
                        </div>
                        <div className="text-green-600 font-semibold">+450.00 ر.س</div>
                      </div>
                      ...
                      <div className="flex items-center justify-between p-3 bg-secondary/50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium">سحب إلى الحساب البنكي</p>
                            <p className="text-sm text-muted-foreground">منذ أسبوع</p>
                          </div>
                        </div>
                        <div className="text-red-600 font-semibold">-800.00 ر.س</div>
                      </div>
                    </div>
                  </div>
          ...
          <TabsContent value="points">
            <Card>
              <CardHeader>
                ...
                <CardDescription>اكسب نقاط واستبدلها بخصومات وعروض حصرية</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="text-center p-6 bg-primary/5 rounded-lg">
                    <div className="text-4xl font-bold text-primary mb-2">{stats.points}</div>
                    <div className="text-sm text-muted-foreground">نقطة متاحة</div>
                  </div>
                  
                  <div className="space-y-4">
                    <h4 className="font-semibold">كيف تكسب النقاط؟</h4>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-center gap-2">
                        <Award className="h-4 w-4 text-primary" />
                        كل 150 ريال إنفاق = 10 نقاط
                      </li>
                      <li className="flex items-center gap-2">
                        <Star className="h-4 w-4 text-primary" />
                        تقييم الفعاليات = 5 نقاط
                      </li>
                      <li className="flex items-center gap-2">
                        <Users className="h-4 w-4 text-primary" />
                        دعوة الأصدقاء = 50 نقطة
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="font-semibold mb-4">المكافآت المتاحة</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="border rounded-lg p-4">
                      <div className="flex justify-between items-start mb-2">
                        <h5 className="font-medium">خصم 10%</h5>
                        <Badge variant="outline">100 نقطة</Badge>
                      </div>
                      <p className="text-sm text-muted-foreground">خصم 10% على الفعالية القادمة</p>
                      <Button size="sm" className="mt-3 w-full" disabled={stats.points < 100}>
                        استبدال
                      </Button>
                    </div>
                    ...
                    <div className="border rounded-lg p-4">
                      <div className="flex justify-between items-start mb-2">
                        <h5 className="font-medium">خصم 25%</h5>
                        <Badge variant="outline">250 نقطة</Badge>
                      </div>
                      <p className="text-sm text-muted-foreground">خصم 25% على أي فعالية</p>
                      <Button size="sm" className="mt-3 w-full" disabled={stats.points < 250}>
                        استبدال
                      </Button>
                    </div>
                  </div>
          ...
          <TabsContent value="reviews">
            <Card>
              <CardHeader>
                ...
                <CardDescription>تقييمات العملاء والمشاركين</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center mb-6">
                  <div className="text-4xl font-bold text-primary mb-2">{stats.rating}</div>
                  ...
                  <p className="text-sm text-muted-foreground">متوسط التقييم من 24 مراجعة</p>
                </div>
                
                <Separator className="my-6" />
                
                <div className="space-y-4">
                  <h4 className="font-semibold">آخر المراجعات</h4>
                  
                  {/* Sample reviews - in real app load from database */}
                  <div className="space-y-4">
                    <div className="border rounded-lg p-4">
