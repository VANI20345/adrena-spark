        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <div className="w-full overflow-x-auto" dir={isRTL ? 'rtl' : 'ltr'}>
            <TabsList className="inline-flex w-max min-w-full h-auto flex-wrap gap-2 p-2 bg-muted rounded-lg">
              ...
              <TabsTrigger value="tickets" className="whitespace-nowrap">{language === 'ar' ? 'التذاكر' : 'Tickets'}</TabsTrigger>
              <TabsTrigger value="entity-reports" className="whitespace-nowrap">{language === 'ar' ? 'بلاغات المحتوى' : 'Content Reports'}</TabsTrigger>
