...
import { ServiceCategoriesHierarchical } from '@/components/Admin/ServiceCategoriesHierarchical';
            ...
            <TabsList className="inline-flex w-max min-w-full h-auto flex-wrap gap-2 p-2 bg-muted rounded-lg">
              ...
              <TabsTrigger value="reviews" className="whitespace-nowrap">
                ...
                {stats.pendingReviews > 0 && (
                  <Badge variant="destructive" className="mr-1">{stats.pendingReviews}</Badge>
                )}
              </TabsTrigger>
              ...
              <TabsTrigger value="contact" className="whitespace-nowrap">رسائل التواصل</TabsTrigger>
              <TabsTrigger value="reports" className="whitespace-nowrap">البلاغات</TabsTrigger>
