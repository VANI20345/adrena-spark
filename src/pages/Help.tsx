                  ...
                  {filteredFaqs.map((faq, index) => (
                    ...
                    >
                      <CollapsibleTrigger asChild>
                        <Button
                          variant="ghost"
                          className={`w-full justify-between p-4 h-auto ${language === 'ar' ? 'text-right' : 'text-left'}`}
                        >
                      ...
                      <CollapsibleContent>
                        <div className={`px-4 pb-4 text-muted-foreground ${language === 'ar' ? 'text-right' : 'text-left'}`}>
                          {faq.answer}
                        </div>
                      </CollapsibleContent>
                    </Collapsible>
