                  ...
                  {filteredFaqs.map((faq, index) => (
                    ...
                    >
                      <CollapsibleTrigger asChild>
                        <Button
                          variant="ghost"
                          className={`w-full p-4 h-auto hover:bg-primary/10 hover:text-primary dark:hover:bg-primary/20 dark:hover:text-primary-foreground transition-colors ${isRTL ? 'flex-row-reverse justify-between text-right' : 'justify-between text-left'} ${openFaq === index ? 'bg-primary/10 text-primary dark:bg-primary/20' : ''}`}
                        >
            ...
            <Card>
              ...
              <CardContent>
                <div className={`space-y-2 ${isRTL ? 'text-right' : 'text-left'}`}>
                  <Button variant="ghost" className={`w-full hover:bg-primary/10 hover:text-primary dark:hover:bg-primary/20 dark:hover:text-primary-foreground transition-colors ${isRTL ? 'justify-end flex-row-reverse' : 'justify-start'}`} asChild>
