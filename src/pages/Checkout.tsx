...
const CheckoutPage = () => {
  ...
  const [bookingId, setBookingId] = useState<string>(existingBookingId || '');
  ...
  const total = discountedSubtotal; // Total is the discounted subtotal (VAT already included)
