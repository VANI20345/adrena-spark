...
const CheckoutPage = () => {
  ...
  const displayPrice = isServiceBooking ? servicePrice : eventPrice;
  ...
  const basePrice = eventDetails?.price || displayPrice || 150;
  const vatRate = 0.15;
  ...
  const subtotal = basePrice * tickets; // This is the final price (VAT included)
