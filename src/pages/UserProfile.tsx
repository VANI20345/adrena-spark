    ...
    queryFn: async () => {
      const { data } = await supabase
        ...
        .select(`
          ...
          joined_at,
          role,
          groups!inner(id, group_name, image_url, current_members, description, created_at)
        `)
        .eq('user_id', userId!)
        .limit(6);
      return data?.map(g => ({ 
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <AchievementsSection
          ...
          isShieldMember={(profile as any).is_shield_member}
          totalPoints={(profile as any).points_balance || 0}
