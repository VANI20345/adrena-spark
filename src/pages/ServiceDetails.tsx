                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="flex items-start gap-2">
                      ...
                      <span className="text-sm text-muted-foreground">خدمة احترافية</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />
                      <span className="text-sm text-muted-foreground">جودة عالية</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />
                    ...
                    <div className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />
                      <span className="text-sm text-muted-foreground">ضمان الخدمة</span>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-semibold mb-2">شروط الخدمة</h4>
                      <div className="space-y-2">
                        <div className="flex items-start gap-2">
                          <Shield className="w-4 h-4 text-orange-500 mt-1 flex-shrink-0" />
                          <span className="text-sm text-muted-foreground">خدمة معتمدة ومضمونة</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <Shield className="w-4 h-4 text-orange-500 mt-1 flex-shrink-0" />
                          <span className="text-sm text-muted-foreground">ضمان رضا العملاء</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <Shield className="w-4 h-4 text-orange-500 mt-1 flex-shrink-0" />
                          <span className="text-sm text-muted-foreground">دعم فني متاح</span>
                        </div>
                      </div>
                    </div>
                  </div>
