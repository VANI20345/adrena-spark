...
const JoinReferral = () => {
  ...
  if (isInvalid || isExpired || !refCode || !referrer) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-destructive/5 via-background to-destructive/10 flex flex-col">
        <Navbar />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-primary/10 flex flex-col">
      <Navbar />
      <main className="container mx-auto px-4 py-12 max-w-lg flex-1">
        <motion.div
