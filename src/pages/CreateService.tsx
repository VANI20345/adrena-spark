...
const CreateService = () => {
  ...
  const categories = [
    { id: "1", name: "معدات", nameAr: "معدات" },
    { id: "2", name: "إرشاد", nameAr: "إرشاد" },
    { id: "3", name: "تصوير", nameAr: "تصوير" },
    { id: "4", name: "طعام", nameAr: "طعام" },
    { id: "5", name: "نقل", nameAr: "نقل" },
    { id: "6", name: "تدريب", nameAr: "تدريب" }
  ];
