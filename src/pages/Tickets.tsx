        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Tabs defaultValue="open" className="w-full">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="open">{isRTL ? 'التذاكر المفتوحة' : 'Open Tickets'}</TabsTrigger>
              <TabsTrigger value="resolved">{isRTL ? 'التذاكر المحلولة' : 'Resolved Tickets'}</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="resolved" className="space-y-6">
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold mb-2">
                  {isRTL ? 'لا توجد تذاكر محلولة' : 'No resolved tickets'}
                </h3>
                <p className="text-muted-foreground">
                  {isRTL ? 'ستظهر التذاكر المحلولة هنا' : 'Resolved tickets will appear here'}
                </p>
              </div>
            </TabsContent>

            {/* QR Scanner Tab - now accessible from Open Tickets */}
            <TabsContent value="scan-qr" className="space-y-6 hidden">
              <Card>
                <CardHeader>
