  ...
  const fetchUserTickets = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "حدث خطأ أثناء تحميل تذاكرك",
        variant: "destructive"
      });
    } finally {
      setLoading(false);
            ...
            <TabsContent value="my-tickets" className="space-y-6">
              {loading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-semibold mb-2">لا توجد تذاكر</h3>
                  <p className="text-muted-foreground">لم تقم بحجز أي فعاليات بعد</p>
                </div>
              ) : (
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-4 text-sm text-muted-foreground mb-3">
                              <div className="flex items-center gap-1">
                                ...
                                {new Date(ticket.bookings?.events?.start_date).toLocaleDateString('ar-SA')} • {new Date(ticket.bookings?.events?.start_date).toLocaleTimeString('ar-SA', { hour: '2-digit', minute: '2-digit' })}
                              </div>
                              <div className="flex items-center gap-1">
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            {ticket.checked_in_at && (
                              <div>
                                ...
                                <p>{new Date(ticket.checked_in_at).toLocaleString('ar-SA')}</p>
                              </div>
                            )}
                          </div>
