  ...
  const sections = [
    {
      ...
      title: "1. قبول الشروط",
      content: [
        "باستخدام منصة أدرينا، فإنك توافق على الالتزام بهذه الشروط والأحكام.",
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            اقرأ شروط وأحكام استخدام منصة أدرينا بعناية
          </p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                مرحباً بك في أدرينا، منصة الأنشطة الخارجية والمغامرات في المملكة العربية السعودية. 
