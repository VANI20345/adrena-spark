        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-transparent">
            ...
            <CardContent className="space-y-6">
              ...
              <div dir={isRTL ? 'rtl' : 'ltr'} className={`flex items-start gap-3 p-4 bg-success/5 rounded-lg border border-success/20 ${isRTL ? 'flex-row-reverse' : ''}`}>
                <Tag className="w-5 h-5 text-success flex-shrink-0 mt-0.5" />
                <div className={`flex-1 ${isRTL ? 'text-right' : 'text-left'}`}>
                  <Badge variant="secondary" className="bg-success/10 text-success mb-2">
                    {localT.discountExemption}
                  </Badge>
                  <p className={`text-sm text-success ${isRTL ? 'text-right' : 'text-left'}`}>
