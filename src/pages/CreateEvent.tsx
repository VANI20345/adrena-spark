...
const CreateEvent = () => {
  ...
  const categories = [
    { id: "1", name: "هايكنج ومشي", nameAr: "هايكنج ومشي" },
    { id: "2", name: "غوص وسباحة", nameAr: "غوص وسباحة" },
    { id: "3", name: "تخييم", nameAr: "تخييم" },
    { id: "4", name: "ركوب الدراجات", nameAr: "ركوب الدراجات" },
    { id: "5", name: "تسلق الجبال", nameAr: "تسلق الجبال" },
    { id: "6", name: "تصوير الطبيعة", nameAr: "تصوير الطبيعة" }
  ];
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast({
        title: "تم بنجاح!",
        description: "تم إنشاء الفعالية وإرسالها للمراجعة"
      });
