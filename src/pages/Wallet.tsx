              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-3">
                  <Dialog>
                    ...
                    <DialogContent className="sm:max-w-md">
                      <DialogHeader>
                        <DialogTitle>تحويل فوري</DialogTitle>
                        <DialogDescription>
                          اسحب أموالك بشكل فوري إلى حسابك البنكي
                        </DialogDescription>
                      </DialogHeader>
                      <p className="text-sm">سيتم تحويل الأموال خلال ساعات قليلة مع رسوم 10 ريال للتحويل الفوري.</p>
                    </DialogContent>
                  </Dialog>
                  ...
                  <Link to={`/${userRole}-dashboard`} className="flex items-center gap-3 p-4 border rounded-lg hover:bg-muted/50 transition-colors cursor-pointer">
