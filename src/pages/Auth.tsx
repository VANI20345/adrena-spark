  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-40 h-40 opacity-20">
        <svg viewBox="0 0 200 200" className="w-full h-full text-[hsl(var(--brand-orange))]" fill="currentColor">
          <path d="M100,0 L120,80 L200,100 L120,120 L100,200 L80,120 L0,100 L80,80 Z" />
        </svg>
      </div>
      <div className="absolute bottom-10 left-10 w-4 h-4 rounded-full bg-[hsl(var(--brand-lime))] opacity-30 hidden md:block" />
      <div className="absolute top-1/4 left-[8%] w-3 h-3 rounded-full bg-[hsl(var(--brand-teal))] opacity-25 hidden md:block" />
      <Card className="w-full max-w-md border-[hsl(var(--brand-lime)/0.15)] relative z-10">
          ...
          {resetSuccess ? (
            <div className="space-y-4">
              <Alert className="bg-success/10 border-success/30">
                <AlertDescription className={`${language === 'ar' ? 'text-right' : 'text-left'} text-success`}>
