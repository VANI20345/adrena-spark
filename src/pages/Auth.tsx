    ...
    try {
      if (!isLogin) {
        ...
        if (error) {
          ...
          setSuccess('تم إنشاء الحساب بنجاح! تم إرسال رسالة تأكيد إلى بريدك الإلكتروني. يرجى التحقق من بريدك الإلكتروني (بما في ذلك مجلد البريد غير الهام) والنقر على الرابط لتفعيل حسابك.');
        }
      } else {
        // Sign in
