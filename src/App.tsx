...
import GlobalRewardListener from "@/components/Referral/GlobalRewardListener";
...
// EarningsReport route intentionally disabled — page hidden from users
const PointsPage = lazy(() => import("./pages/Points"));
const MyEventsPage = lazy(() => import("./pages/MyEvents"));
const MyServicesPage = lazy(() => import("./pages/MyServices"));
      ...
      <GlobalErrorBoundary>
        <ErrorBoundary>
          ...
          <BrowserRouter>
                  ...
                  <MaintenanceCheck>
                    <Suspense fallback={<PageLoader />}>
                      <Routes>
                        ...
                        />
                        <Route path="/services/discount-services" element={<FeatureGate feature="discounts"><DiscountServicesPage /></FeatureGate>} />
                        <Route path="/services/training-services" element={<FeatureGate feature="trainings"><TrainingServicesPage /></FeatureGate>} />
                        <Route path="/services/other-services" element={<FeatureGate feature="services"><OtherServicesPage /></FeatureGate>} />
            ...
            />
            {/* /earnings-report intentionally removed from UI */}
            <Route 
              path="/points" 
              element={
                <ProtectedRoute requireAuth={true}>
            ...
            <Route 
              ...
              element={
                <ProtectedRoute requireAuth={false}>
                  <FeatureGate feature="groups"><GroupsOverview /></FeatureGate>
                </ProtectedRoute>
              } 
            />
            <Route
              ...
              element={
                <ProtectedRoute requireAuth={true}>
                  <FeatureGate feature="groups"><JoinedGroups /></FeatureGate>
                </ProtectedRoute>
              } 
            />
            <Route 
              ...
              element={
                <ProtectedRoute requireAuth={true}>
                  <FeatureGate feature="groups"><OrganizedGroups /></FeatureGate>
                </ProtectedRoute>
              } 
            />
            <Route 
              ...
              element={
                <ProtectedRoute requireAuth={false}>
                  <FeatureGate feature="groups"><DiscoverGroups /></FeatureGate>
                </ProtectedRoute>
              } 
            />
            <Route 
              ...
              element={
                <ProtectedRoute requireAuth={true}>
                  <FeatureGate feature="groups"><FilterGroups /></FeatureGate>
                </ProtectedRoute>
              } 
            />
            <Route 
              ...
              element={
                <ProtectedRoute requireAuth={false}>
                  <FeatureGate feature="groups"><GroupDetails /></FeatureGate>
                </ProtectedRoute>
              } 
            />
            <Route 
              ...
              element={
                <ProtectedRoute requireAuth={true}>
                  <FeatureGate feature="groups"><GroupEventsPage /></FeatureGate>
                </ProtectedRoute>
              } 
            />
            <Route 
              ...
              element={
                <ProtectedRoute requireAuth={true}>
                  <FeatureGate feature="groups"><GroupCreateEvent /></FeatureGate>
                </ProtectedRoute>
              } 
            />
            <Route 
            ...
            {/* Messages Routes */}
            <Route path="/messages" element={<ProtectedRoute requireAuth={true} requiredRole={['attendee', 'provider', 'admin']}><Messages /></ProtectedRoute>} />
            <Route path="/messages/:conversationId" element={<ProtectedRoute requireAuth={true} requiredRole={['attendee', 'provider', 'admin']}><Messages /></ProtectedRoute>} />
            {/* Referral Routes */}
            <Route path="/join" element={<JoinReferral />} />
            <Route path="/referral" element={<ProtectedRoute requireAuth={true}><Referral /></ProtectedRoute>} />
            {/* Achievements Route */}
            <Route path="/achievements" element={<ProtectedRoute requireAuth={true}><Achievements /></ProtectedRoute>} />
            {/* Super Admin Route */}
            <Route 
              path="/super-admin" 
              element={
