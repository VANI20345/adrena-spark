  ...
  public: {
    Tables: {
      ...
      financial_transaction_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "financial_transaction_logs_invoice_id_fkey"
            columns: ["invoice_id"]
            isOneToOne: false
      ...
      form_submissions: {
        Row: {
          created_at: string
          desired_hobbies: string[]
          dream_experience_story: string | null
          email: string | null
          enjoy_more_story: string | null
      ...
      payment_holds: {
        Row: {
          auto_split_percent: number | null
          ...
          review_state: Database["public"]["Enums"]["hold_review_state"]
          source_id: string
          source_type: Database["public"]["Enums"]["payment_hold_source"]
          status: Database["public"]["Enums"]["payment_hold_status"]
          updated_at: string
          vat_amount: number
        }
        Insert: {
    ...
    Functions: {
      ...
      backfill_missing_invoices: { Args: never; Returns: Json }
      ...
      cleanup_expired_booking_reservations: { Args: never; Returns: number }
      cleanup_stale_pending_payments: { Args: never; Returns: Json }
      confirm_paid_booking: {
        Args: {
          p_booking_id: string
          p_booking_type: string
          p_payment_id: string
          p_provider_amount_halalas?: number
        }
        Returns: Json
      }
      ...
      flag_payment_hold_complaint: {
        Args: { p_extend_until?: string; p_hold_id: string; p_reason: string }
        Returns: Json
      }
      ...
      generate_refund_invoice: { Args: { p_refund_id: string }; Returns: Json }
      get_financial_dashboard_stats: { Args: never; Returns: Json }
      ...
      get_payment_holds_summary: {
        Args: never
        Returns: {
          count_held: number
          count_ready_to_release: number
          count_released: number
          count_with_complaints: number
          total_held: number
      ...
      recalculate_active_holds: {
        Args: { p_new_hold_pct: number }
        Returns: Json
      }
      reconcile_pending_payment: {
        Args: {
          p_moyasar_amount_halalas: number
          p_moyasar_status: string
          p_payment_row_id: string
        }
        Returns: Json
      }
      redeem_referral_code: { Args: { p_code: string }; Returns: Json }
      release_payment_hold: {
        Args: { p_force?: boolean; p_hold_id: string; p_notes?: string }
        Returns: Json
      }
      request_group_join: {
        Args: {
