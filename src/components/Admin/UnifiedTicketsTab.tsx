    ...
    <Card dir={isRTL ? 'rtl' : 'ltr'}>
      <CardHeader className={isRTL ? 'text-right' : 'text-left'}>
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <CardTitle className={isRTL ? 'text-right' : 'text-left'}>{t('admin.tickets.title')}</CardTitle>
          <Select value={filterStatus} onValueChange={setFilterStatus}>
            <SelectTrigger className={`w-[180px] ${isRTL ? 'text-right flex-row-reverse' : 'text-left'}`} dir={isRTL ? 'rtl' : 'ltr'}>
            ...
            <SelectContent dir={isRTL ? 'rtl' : 'ltr'} className={isRTL ? 'text-right' : 'text-left'}>
              <SelectItem value="all" className={isRTL ? 'flex-row-reverse justify-end text-right' : ''}>{t('admin.tickets.allTickets')}</SelectItem>
              <SelectItem value="pending" className={isRTL ? 'flex-row-reverse justify-end text-right' : ''}>{t('admin.tickets.statusPending')}</SelectItem>
              <SelectItem value="in_progress" className={isRTL ? 'flex-row-reverse justify-end text-right' : ''}>{t('admin.tickets.statusInProgress')}</SelectItem>
              <SelectItem value="resolved" className={isRTL ? 'flex-row-reverse justify-end text-right' : ''}>{t('admin.tickets.statusResolved')}</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </CardHeader>
      <CardContent>
        <Tabs defaultValue="support" className="w-full" dir={isRTL ? 'rtl' : 'ltr'}>
