              ...
              return (
                <Card key={mainCat.id} className="overflow-hidden" dir={isRTL ? 'rtl' : 'ltr'}>
                  <CardHeader className="bg-muted/50">
                    <div className="service-row flex items-center justify-between gap-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid gap-2">
                          {subCats.map((subCat) => (
                            <div
                              key={subCat.id}
                              className="service-row flex items-center justify-between gap-3 p-3 border rounded-lg bg-background hover:bg-muted/50 transition-colors"
                              dir={isRTL ? 'rtl' : 'ltr'}
                            >
                              <div className="flex items-center gap-3">
