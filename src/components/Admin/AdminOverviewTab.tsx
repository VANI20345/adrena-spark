      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className={`flex items-center gap-3 p-4 rounded-lg bg-success/10 ${isRTL ? 'flex-row-reverse' : ''}`}>
            ...
            <div className={`flex items-center gap-3 p-4 rounded-lg bg-info/10 ${isRTL ? 'flex-row-reverse' : ''}`}>
