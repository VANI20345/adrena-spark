  ...
  return (
    <div className="space-y-4">
      ...
      <CardContent className="space-y-4">
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 ${isRTL ? 'rtl' : 'ltr'}`}>
          <Input
        ...
        <CardContent className="p-0">
          <div className="overflow-x-auto" dir={isRTL ? 'rtl' : 'ltr'}>
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className={isRTL ? 'text-right' : ''}>{t('admin.fields.displayId')}</TableHead>
                  <TableHead className={isRTL ? 'text-right' : ''}>{t('admin.fields.name')}</TableHead>
                  <TableHead className={isRTL ? 'text-right' : ''}>{t('admin.fields.email')}</TableHead>
                  <TableHead className={isRTL ? 'text-right' : ''}>{t('admin.fields.role')}</TableHead>
                  <TableHead className={isRTL ? 'text-right' : ''}>{t('admin.fields.status')}</TableHead>
                  <TableHead className={isRTL ? 'text-right' : ''}>{t('admin.fields.registeredAt')}</TableHead>
                  <TableHead className={isRTL ? 'text-left' : 'text-right'}>{t('admin.fields.actions')}</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
