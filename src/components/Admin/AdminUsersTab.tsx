            ...
            <CardTitle className="flex items-center gap-2 w-full">
              {isRTL ? (
                <>
                  ...
                  <Users className="h-5 w-5 shrink-0 ms-auto" />
                </>
              ) : (
                <>
        ...
        <CardContent className="space-y-4">
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-4`}>
            ...
            <Select value={filterRole} onValueChange={onFilterRoleChange}>
              <SelectTrigger className={isRTL ? 'text-right flex-row-reverse' : 'text-left'} dir={isRTL ? 'rtl' : 'ltr'}>
                <SelectValue />
              </SelectTrigger>
              <SelectContent dir={isRTL ? 'rtl' : 'ltr'} className={isRTL ? 'text-right' : 'text-left'}>
                <SelectItem value="all" className={isRTL ? 'text-right flex-row-reverse justify-end' : ''}>{t('admin.filters.allRoles')}</SelectItem>
                <SelectItem value="attendee" className={isRTL ? 'text-right flex-row-reverse justify-end' : ''}>{t('admin.filters.attendee')}</SelectItem>
                <SelectItem value="provider" className={isRTL ? 'text-right flex-row-reverse justify-end' : ''}>{t('admin.filters.provider')}</SelectItem>
                <SelectItem value="admin" className={isRTL ? 'text-right flex-row-reverse justify-end' : ''}>{t('admin.filters.admin')}</SelectItem>
              </SelectContent>
            </Select>
            <Select value={filterStatus} onValueChange={(v) => onFilterStatusChange(v as any)}>
              ...
              <SelectContent dir={isRTL ? 'rtl' : 'ltr'} className={isRTL ? 'text-right' : 'text-left'}>
                <SelectItem value="all" className={isRTL ? 'text-right flex-row-reverse justify-end' : ''}>{t('admin.filters.allStatus')}</SelectItem>
                <SelectItem value="active" className={isRTL ? 'text-right flex-row-reverse justify-end' : ''}>{t('admin.filters.active')}</SelectItem>
                <SelectItem value="suspended" className={isRTL ? 'text-right flex-row-reverse justify-end' : ''}>{t('admin.filters.suspended')}</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </CardContent>
