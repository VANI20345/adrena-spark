      ...
      <CardContent>
        <div className="overflow-x-auto" dir={isRTL ? 'rtl' : 'ltr'}>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className={isRTL ? 'text-right' : ''}>{t('admin.fields.eventTitle')}</TableHead>
                <TableHead className={isRTL ? 'text-right' : ''}>{t('admin.fields.organizer')}</TableHead>
                <TableHead className={isRTL ? 'text-right' : ''}>{t('admin.fields.date')}</TableHead>
                <TableHead className={isRTL ? 'text-right' : ''}>{t('admin.fields.price')}</TableHead>
