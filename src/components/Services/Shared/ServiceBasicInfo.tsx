        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className={description.length < 20 ? "text-destructive" : "text-muted-foreground"}>
                {description.length}/20 حرف
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea 
                  placeholder="وصف مفصل للخدمة (20 حرف على الأقل)"
                  className="min-h-[150px]"
                  {...field} 
                />
              </FormControl>
              <FormDescription className={descriptionAr.length < 20 ? "text-destructive" : "text-muted-foreground"}>
                {descriptionAr.length}/20 حرف
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
