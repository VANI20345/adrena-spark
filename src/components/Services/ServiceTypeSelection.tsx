  ...
  const serviceTypes = [
    {
      ...
      enabled: toggles.discounts !== false
    },
    {
      type: 'training',
      ...
      enabled: toggles.trainings !== false
    },
    {
      type: 'other',
      ...
      enabled: toggles.services !== false
    }
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className={`grid gap-6 ${serviceTypes.length === 1 ? 'max-w-md mx-auto grid-cols-1' : serviceTypes.length === 2 ? 'max-w-3xl mx-auto md:grid-cols-2' : 'md:grid-cols-3'}`}>
