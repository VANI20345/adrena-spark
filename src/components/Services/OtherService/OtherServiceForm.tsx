...
import { Package, Calendar, MapPin, Users, DollarSign } from "lucide-react";
...
const OtherServiceForm = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast({ title: "تم بنجاح!", description: "تم إنشاء الخدمة الإضافية وإرسالها للمراجعة" });
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              إنشاء خدمة إضافية أخرى
            </h1>
            <p className="text-lg text-muted-foreground">
              قدم خدمات متنوعة أخرى للمغامرين
            </p>
          </div>
