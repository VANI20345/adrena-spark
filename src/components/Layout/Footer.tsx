        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/organizer" className="text-sm text-muted-foreground hover:text-primary smooth-transition">أنشئ فعاليتك</Link></li>
              <li><Link to="/provider" className="text-sm text-muted-foreground hover:text-primary smooth-transition">قدّم خدمتك</Link></li>
            </ul>
          </div>
