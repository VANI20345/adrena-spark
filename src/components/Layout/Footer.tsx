...
const Footer = () => {
  ...
  return (
    <footer className="bg-secondary border-t border-secondary mt-auto shrink-0">
      {/* Top brand accent line */}
      <div className="h-1 w-full bg-gradient-to-r from-[hsl(var(--brand-lime))] via-[hsl(var(--brand-orange))] to-[hsl(var(--brand-purple))]" />
