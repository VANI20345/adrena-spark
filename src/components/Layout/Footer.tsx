        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 rtl:space-x-reverse">
              <a key="instagram" href={socialLinks.instagram || 'https://instagram.com'} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <Instagram className="w-5 h-5 text-muted-foreground hover:text-primary cursor-pointer smooth-transition" />
              </a>
              <a key="twitter" href={socialLinks.twitter || 'https://x.com'} target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                <XIcon className="w-5 h-5 text-muted-foreground hover:text-primary cursor-pointer smooth-transition" />
              </a>
              <a key="tiktok" href="https://tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
