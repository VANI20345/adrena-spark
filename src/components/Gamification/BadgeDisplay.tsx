...
// Shield Badge specifically for beta users - Premium glassmorphism design
  ...
  return (
    <TooltipProvider>
      <Tooltip delayDuration={100}>
        <TooltipTrigger asChild>
          <motion.div 
            className={cn(
              ...
              'shadow-lg shadow-amber-400/40 border-2 border-amber-300/50',
              sizeClasses[size]
            )}
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-white/10 to-white/30 backdrop-blur-[1px]" />
            
            {/* Animated glow ring */}
            <motion.div
              className="absolute inset-[-2px] rounded-full bg-gradient-to-r from-amber-300 via-yellow-200 to-amber-300"
              animate={{ rotate: 360 }}
            ...
            {/* Inner circle */}
            <div className="absolute inset-[2px] rounded-full bg-gradient-to-br from-amber-400 via-yellow-500 to-orange-500" />
        ...
        <TooltipContent side="top" className="p-3 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/90 dark:to-orange-950/90 border-amber-200 dark:border-amber-800">
          <div className="flex items-center gap-2 mb-1">
            <p className="font-bold text-amber-800 dark:text-amber-200">
              {isRTL ? 'الدرع' : 'The Shield'}
            </p>
            <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-amber-200 text-amber-800 dark:bg-amber-800 dark:text-amber-200 uppercase tracking-wide font-bold">
              Beta
            </span>
          </div>
