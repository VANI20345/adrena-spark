...
import { Heart, MessageCircle, Image as ImageIcon, Play, Flag, MoreHorizontal } from 'lucide-react';
...
export const GroupPostsFeed: React.FC<GroupPostsFeedProps> = ({ groupId, userRole }) => {
  ...
  const [likesDialogPost, setLikesDialogPost] = useState<any | null>(null);
  ...
  return (
    <div className="space-y-4">
                ...
                <div className="px-4 pt-2 pb-3">
                  ...
                  <div className="flex items-center gap-4 text-xs text-muted-foreground mb-3">
                    <button 
                      ...
                      onClick={() => setLikesDialogPost(post)}
                    >
      ...
      {likesDialogPost && (
        <PostLikesDialog
          postId={likesDialogPost.id}
          open={!!likesDialogPost}
          onClose={() => setLikesDialogPost(null)}
          likesCount={likesDialogPost.likes_count || 0}
        />
      )}
