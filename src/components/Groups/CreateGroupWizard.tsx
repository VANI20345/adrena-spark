        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          <form id="create-group-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <Card className="p-4 border-l-4 border-l-secondary">
              <h3 className="text-lg font-semibold mb-4">
                {isRTL ? 'الخصوصية والوصول' : 'Privacy & Access'}
              </h3>
              ...
              <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center space-x-2 space-x-reverse">
                      ...
                      <Label htmlFor="open" className="font-normal cursor-pointer">
                        {isRTL ? 'مفتوح للجميع - أي شخص يمكنه الانضمام' : 'Open to all - Anyone can join freely'}
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2 space-x-reverse">
                      <RadioGroupItem value="request" id="request" />
                      <Label htmlFor="request" className="font-normal cursor-pointer">
                        {isRTL ? 'طلب للانضمام - يتطلب موافقة المشرف' : 'Request to join - Admin approval required'}
                      </Label>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div className="space-y-2">
                  <Label className="flex items-center gap-1">
                    {isRTL ? 'رؤية المجموعة' : 'Group Visibility'}
                    <span className="text-destructive">*</span>
                  </Label>
                  <RadioGroup
                  ...
                  >
                    <div className="flex items-center space-x-2 space-x-reverse">
                      ...
                      <Label htmlFor="public" className="font-normal cursor-pointer">
                        {isRTL ? 'عامة - مرئية للجميع' : 'Public - Visible to everyone'}
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2 space-x-reverse">
                      <RadioGroupItem value="private" id="private" />
                      <Label htmlFor="private" className="font-normal cursor-pointer">
                        {isRTL ? 'خاصة - مرئية بالدعوة فقط' : 'Private - Visible only by invite'}
                      </Label>
                    </div>
                  </RadioGroup>
                </div>
