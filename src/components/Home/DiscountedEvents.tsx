...
const DiscountedEvents = () => {
  ...
  const { data: discountedServices = [], isLoading: loading } = useQuery({
    ...
    queryFn: async () => {
      // Fetch ALL approved services and filter client-side for reliability
