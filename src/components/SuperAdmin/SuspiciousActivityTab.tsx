          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between gap-3">
              <div className={`flex items-center gap-3 min-w-0 ${isRTL ? 'flex-row-reverse' : ''}`}>
                ...
                <p className="text-sm text-muted-foreground truncate">{t.totalActions}</p>
              </div>
              <p className="text-3xl font-bold tabular-nums" dir="ltr">{stats.total}</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between gap-3">
              <div className={`flex items-center gap-3 min-w-0 ${isRTL ? 'flex-row-reverse' : ''}`}>
                ...
                <p className="text-sm text-muted-foreground truncate">{t.todayActions}</p>
              </div>
              <p className="text-3xl font-bold text-blue-600 tabular-nums" dir="ltr">{stats.today}</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between gap-3">
              <div className={`flex items-center gap-3 min-w-0 ${isRTL ? 'flex-row-reverse' : ''}`}>
                ...
                <p className="text-sm text-muted-foreground truncate">{t.roleChanges}</p>
              </div>
              <p className="text-3xl font-bold text-purple-600 tabular-nums" dir="ltr">{stats.roleChanges}</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between gap-3">
              <div className={`flex items-center gap-3 min-w-0 ${isRTL ? 'flex-row-reverse' : ''}`}>
                ...
                <p className="text-sm text-muted-foreground truncate">{t.suspensions}</p>
              </div>
              <p className="text-3xl font-bold text-red-600 tabular-nums" dir="ltr">{stats.suspensions}</p>
            </div>
          </CardContent>
        </Card>
      </div>
