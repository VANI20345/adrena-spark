          ...
          <Card key={index} className="relative">
            ...
            <CardContent className="pt-6">
              <div className={`flex items-center gap-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
                <div className={`p-3 rounded-full shrink-0 ${card.bgColor}`}>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3" dir={isRTL ? 'rtl' : 'ltr'}>
              <button 
                ...
                className={"flex flex-col items-center justify-center text-center p-4 border rounded-lg hover:bg-muted transition-colors"}
              >
