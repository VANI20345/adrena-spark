...
import { Save, Loader2, Globe, Youtube, Instagram, Facebook, Info, ExternalLink, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6" dir={isRTL ? 'rtl' : 'ltr'}>
      <div className={`flex items-start justify-between gap-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
        ...
        <Button onClick={handleSave} disabled={saving || !hasUnsavedChanges} className={isRTL ? 'flex-row-reverse self-start' : 'self-start'}>
          {saving ? (
