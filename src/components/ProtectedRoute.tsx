...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ 
  ...
  if (user && (profile as any)?.is_suspended) {
  ...
  // Allow anonymous users to groups overview, discover-groups and individual group pages (for preview)
  if (!user && location.pathname.startsWith('/groups')) {
    const allowedPaths = ['/groups', '/groups/', '/groups/discover-groups'];
