    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-base">نوع الخدمة</Label>
      ...
      <div className="space-y-4 pt-4 border-t">
        <Label className="text-base">المستندات المطلوبة</Label>
        
        {/* ID Document */}
        <div className="space-y-2">
          <Label htmlFor="idDocument" className="text-sm">صورة الهوية *</Label>
        ...
        <div className="space-y-2">
          <Label htmlFor="commercialReg" className="text-sm">السجل التجاري *</Label>
          <div className="flex items-center gap-2">
            <Input
              id="commercialReg"
              type="file"
        ...
        {/* License */}
        <div className="space-y-2">
          <Label htmlFor="license" className="text-sm">رخصة / تصريح *</Label>
          <div className="flex items-center gap-2">
            <Input
              id="license"
              type="file"
      ...
      <div className="space-y-3 pt-4 border-t">
        ...
        <div className="flex items-start space-x-2 space-x-reverse">
          ...
          />
          <Label htmlFor="agreePrivacy" className="cursor-pointer text-sm leading-relaxed">
            أوافق على{' '}
