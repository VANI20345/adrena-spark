...
const translations = {
  ar: {
    ...
    wallet: {
      ...
      withdraw: 'سحب',
      bonus: 'مكافأة',
      credit: 'إيرادات/إيداع',
      release: 'إفراج عن محجوز',
      withdrawal: 'سحب مالي',
    ...
    refund: {
      ...
      policies: {
        early: {
          type: 'إلغاء مبكر (أكثر من 48 ساعة)',
          description: 'رصيد كامل في المحفظة',
          percentage: '100% رصيد محفظة',
          timeframe: 'أكثر من 48 ساعة قبل الخدمة'
        },
        medium: {
          type: 'إلغاء متوسط (24-48 ساعة)',
          description: 'نصف المبلغ كرصيد في المحفظة',
          percentage: '50% رصيد محفظة',
          timeframe: 'بين 24 و 48 ساعة قبل الخدمة'
        },
        late: {
          type: 'إلغاء متأخر (أقل من 24 ساعة)',
          description: 'لا يوجد استرداد',
          percentage: '0% - لا استرداد',
          timeframe: 'أقل من 24 ساعة قبل الخدمة'
        }
      },
      exceptional: [
    ...
    // Attendee Dashboard
    attendeeDashboard: {
      title: 'لوحة التحكم للمشارك',
      welcome: 'مرحباً',
      exploreDescription: 'استكشف أحدث الفعاليات واحجز مغامرتك القادمة',
      exploreEvents: 'استكشف الفعاليات',
      eventsAttended: 'الفعاليات التي تم حضورها',
      loyaltyPoints: 'نقاط الولاء',
      favoriteOrganizers: 'المنظمون المفضلون',
      upcomingBookings: 'الحجوزات القادمة',
      myUpcomingEvents: 'فعالياتي القادمة',
      myUpcomingEventsDesc: 'الفعاليات التي قمت بحجزها وقريباً ستبدأ',
      viewAll: 'عرض الكل',
      details: 'التفاصيل',
      favoriteEvents: 'الفعاليات المفضلة',
      favoriteEventsDesc: 'الفعاليات التي قمت بإضافتها لقائمة المفضلة',
      quickActions: 'إجراءات سريعة',
      quickActionsDesc: 'الأنشطة الأكثر استخداماً في حسابك',
      redeemPoints: 'استبدال النقاط',
      myGroups: 'مجموعاتي',
      inNext2Weeks: 'خلال الأسبوعين القادمين',
      confirmed: 'مؤكد',
      pending: 'معلق',
      eventOrganizer: 'منظم الفعالية',
      unnamedEvent: 'فعالية بدون اسم',
      pointsThisMonth: 'نقطة هذا الشهر',
      noPointsThisMonth: 'لم تكسب نقاطاً هذا الشهر',
      newOrganizer: 'منظم جديد',
      newOrganizers: 'منظمين جدد',
      noNewOrganizers: 'لا يوجد منظمون جدد',
      fromLastMonth: 'مقارنة بالشهر الماضي',
      sameAsLastMonth: 'نفس عدد الشهر الماضي',
      noEventsBooked: 'لا توجد فعاليات قادمة محجوزة',
      noFavoriteEvents: 'لم تضف أي فعاليات للمفضلة بعد',
      overview: 'نظرة عامة',
      quickStats: 'إحصائيات سريعة',
    ...
    superAdmin: {
      ...
      description: 'إدارة شاملة للنظام والصلاحيات والمالية',
      overview: 'نظرة عامة',
      eventActivation: 'تفعيل الفعاليات',
      ...
      adminPerformanceAction: 'أداء المشرفين',
      activateEvent: 'تفعيل الفعالية',
      rejectEvent: 'رفض الفعالية',
      promoteToAdmin: 'ترقية إلى مشرف',
      demoteFromAdmin: 'إزالة صلاحيات المشرف',
  ...
  en: {
    ...
    refund: {
      ...
      policies: {
        early: {
          type: 'Early Cancellation (More than 48 hours)',
          description: 'Full wallet credit',
          percentage: '100% Wallet Credit',
          timeframe: 'More than 48 hours before service'
        },
        medium: {
          type: 'Medium Cancellation (24-48 hours)',
          description: 'Half amount as wallet credit',
          percentage: '50% Wallet Credit',
          timeframe: 'Between 24 and 48 hours before service'
        },
        late: {
          type: 'Late Cancellation (Less than 24 hours)',
          description: 'No refund available',
          percentage: '0% - No Refund',
          timeframe: 'Less than 24 hours before service'
        }
      },
      exceptional: [
    ...
    attendeeDashboard: {
      ...
      welcome: 'Welcome',
      exploreDescription: 'Explore the latest events and book your next adventure',
      exploreEvents: 'Explore Events',
      eventsAttended: 'Events Attended',
      loyaltyPoints: 'Loyalty Points',
      favoriteOrganizers: 'Favorite Organizers',
      upcomingBookings: 'Upcoming Bookings',
      myUpcomingEvents: 'My Upcoming Events',
      myUpcomingEventsDesc: 'Events you booked that are coming soon',
      viewAll: 'View All',
      details: 'Details',
      favoriteEvents: 'Favorite Events',
      favoriteEventsDesc: 'Events you added to your favorites list',
      quickActions: 'Quick Actions',
      quickActionsDesc: 'Most used activities in your account',
      redeemPoints: 'Redeem Points',
      myGroups: 'My Groups',
      inNext2Weeks: 'In the next 2 weeks',
      confirmed: 'Confirmed',
      pending: 'Pending',
      eventOrganizer: 'Event Organizer',
      unnamedEvent: 'Unnamed Event',
      pointsThisMonth: 'points this month',
      noPointsThisMonth: 'No points earned this month',
      newOrganizer: 'new organizer',
      newOrganizers: 'new organizers',
      noNewOrganizers: 'No new organizers',
      fromLastMonth: 'from last month',
      sameAsLastMonth: 'Same as last month',
      noEventsBooked: 'No upcoming events booked',
      noFavoriteEvents: 'No favorite events added yet',
    },
    ...
    auth: {
      ...
      signupDescription: 'Create a new account to start exploring events',
      backToHome: 'Back to home',
      ...
      resetPasswordEmailSent: 'A message has been sent to',
    ...
    superAdmin: {
      ...
      description: 'Comprehensive system, role, and financial management',
      overview: 'Overview',
      eventActivation: 'Event Activation',
      ...
      adminPerformanceAction: 'Admin Performance',
