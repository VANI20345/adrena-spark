...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const fetchProfile = async (userId: string) => {
    try {
      ...
      if (roleData?.role) {
        // Map 'organizer' to 'attendee' for backwards compatibility
        const mappedRole = roleData.role === 'organizer' ? 'attendee' : roleData.role;
        setUserRoleState(mappedRole as UserRole);
      }
    } catch (error) {
